...
*			<>	Update the Exception Handler register definition with all exception handlers.														*
******************************************************************************************************************/
...
*		i		Base Addresses.																																														*
*		ii	Clock Enable & Disable Macros.																																						*
*		iii	Peripheral Register Definition.																																						*
*		iv	Module Access Pointers.																																										*
******************************************************************************************************************/
...
#define Nvic ( (NVIC_reg*)NVIC_BASE_ADDR )
		...
		*							Enable 0 Reg		Enable 1 Reg		Enable 2 Reg		Enable 3 Reg		Enable 4 Reg										*
		*		Bit				 Interrupt#			 Interrupt#			 Interrupt#			 Interrupt#			 Interrupt#											*
		*		0								0								32							64							96							128												*
		*		1								1								33							65							97							129												*
		*		2								2								34							66							98							130												*
		*		3								3								35							67							99							131												*
...
******************************************************************************************************************/
#define SYS_CLK			16					//	System Clock Frequency (in MHz)
